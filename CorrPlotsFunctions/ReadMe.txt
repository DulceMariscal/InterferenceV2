...
The main function
   * mycorrplot_1.m : Plot the results of correlation (i.e. corr(X)) in a figure with table-like structure.
   * mycorrplot_2.m :  Plot the results of correlation (i.e. corr(X, Y)) in figures with table-like structure.
