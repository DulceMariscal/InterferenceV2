...
storePath = 'C:\Users\dum5\OneDrive\_Shared Drive - Interference Project - Alessandro - Dulce_\Params Files\';
if CREATE_TABLE
    create_rate_table_stata(allRateMeas, rateMeasDef, SMOOTHING, storePath, selPar);
end
if SAVE_DATA
   save([storePath selPar '_smoothed_all_kinds'], 'all_curves', 'all_curves_after_smoothing', 'SMOOTHING','R2s','RMSEs','R2adjs');
end
