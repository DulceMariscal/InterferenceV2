...
for i=1:nfiles
    ...
    m_curves = average_curves_final(all_curves); %It's a 2 X 2 GROUP by CONDITION
    ...
    my_plot_curve_and_data(m_curves,fitCurves,tau,PV,indSubplot,cylims,cylabel,... %These change at every iteration
