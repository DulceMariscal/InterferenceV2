...
for exp = 1:nexps
    ...
    switch model
        ...
        case 21
            x = SSIM_evolve_lisu_5s(k, cinput , x0); %Ignore Small errors + Linear summation 6 states
        case 22
            x = SSIM_evolve_lisu_5sNew(k, cinput , x0); %Ignore Small errors + Linear summation 6 states
        case 31
            x = SSIM_evolve_lisu_3s(k, cinput , x0); %Ignore Small errors + Linear summation 6 states
        case 30
            x = SSIM_evolve_lisu_4s(k, input , x0); %Linear summation 3 states
        case 32
            x = SSIM_evolve_lisu_4s_body(k, input , x0); %Linear summation 3 states
